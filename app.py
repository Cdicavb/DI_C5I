"""
Archivo: app.py
Proyecto: Plataforma C5I Unificada
Rol: Login + WarRoom + Radar Matte (Monolítico Funcional)
"""
...
if not config or not st.session_state.get('authentication_status'):
...
# ==============================================================================
# SECCIÓN 2: CONEXIÓN A SUPABASE Y CARGA DE DATOS
# ==============================================================================
...
# ==============================================================================
# SECCIÓN 4: SIDEBAR Y NAVEGACIÓN
# ==============================================================================
...
# --- MÓDULO 8: RADAR MATTE (SIMPLIFICADO) ---
elif modo_analisis == "🏢 Radar Holding Matte":
    st.subheader("🏢 Central de Inteligencia: Grupo Matte")
    st.info("️ Módulo en desarrollo. Los datos bursátiles requieren conexión a yfinance (puede fallar en Streamlit Cloud).")
    
    st.markdown("""
    ### Estructura del Holding Matte:
    - **CMPC** (Forestal e Industrial) - 45%
    - **Colbún** (Energía) - 25%
    - **Entel** (Telecomunicaciones) - 15%
    - **BICECORP** (Financiero) - 10%
    - **Volcán** (Construcción) - 5%
    """)
    
    st.warning("Los módulos de Cotización en Vivo y Noticias por Frente requieren integración con yfinance y Google News RSS. Pendiente de implementación en la nube.")

st.divider()
st.markdown(f"*Plataforma C5I v2.0 | Usuario: {name} | Rango: {user_role.upper()}*")